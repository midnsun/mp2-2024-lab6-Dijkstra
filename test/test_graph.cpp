...
TEST(myGraph, cant_generate_to_small) {
	myGraph<double> g(6);
	ASSERT_ANY_THROW(g.generate(4));
}
...
TEST(myGraph, can_scan_ud) {
	myGraph<double> g(15);
	std::string s = "2 5 20 1 15 2 6 0 2 25 2 3 10 7 70 1 8 50 1 9 10 1 10 30 2 7 40 10 10 2 8 30 12 60 2 12 5 13 70 1 14 25 1 11 10 1 12 35 1 13 70 0 0";
...
TEST(myGraph, cannot_scan_ud) {
	...
	ASSERT_ANY_THROW(g.scan(s1));
}

TEST(myGraph, can_scan_test) {
//	myGraph<double> g(15);
	graphTest g(15);
	std::string s = "2 5 20 1 15 3 0 15 6 0 2 25 3 1 25 3 10 7 70 2 2 10 8 50 1 9 10 2 0 20 10 30 3 1 0 7 40 10 10 4 6 40 2 70 8 30 12 60 4 7 30 12 5 13 70 3 50 2 4 10 14 25 3 5 30 6 10 11 10 2 10 10 12 35 4 11 35 7 60 8 5 13 70 2 12 70 8 70 1 9 25";
	std::istringstream s1;
	...
	ASSERT_NO_THROW(g.scan_test(s1));
}

TEST(myGraph, scan_test_is_correct) {
//	myGraph<double> g(15);
	graphTest g(15);
	std::string s = "2 5 20 1 15 3 0 15 6 0 2 25 3 1 25 3 10 7 70 2 2 10 8 50 1 9 10 2 0 20 10 30 3 1 0 7 40 10 10 4 6 40 2 70 8 30 12 60 4 7 30 12 5 13 70 3 50 2 4 10 14 25 3 5 30 6 10 11 10 2 10 10 12 35 4 11 35 7 60 8 5 13 70 2 12 70 8 70 1 9 25";
	std::istringstream s1;
...
TEST(myGraph, scan_ud_is_correct) {
	myGraph<double> g(15);
	std::string s = "2 5 20 1 15 2 6 0 2 25 2 3 10 7 70 1 8 50 1 9 10 1 10 30 2 7 40 10 10 2 8 30 12 60 2 12 5 13 70 1 14 25 1 11 10 1 12 35 1 13 70 0 0";
	std::istringstream s1;
	s1.str(s);
	...
	EXPECT_EQ(g.data[5].size(), 2); EXPECT_EQ(g.data[5][0], std::make_pair(0ull, 20.0)); EXPECT_EQ(g.data[5][1], std::make_pair(10ull, 30.0));
	EXPECT_EQ(g.data[6].size(), 3); EXPECT_EQ(g.data[6][0], std::make_pair(1ull, 0.0)); EXPECT_EQ(g.data[6][1], std::make_pair(7ull, 40.0)); EXPECT_EQ(g.data[6][2], std::make_pair(10ull, 10.0));
	EXPECT_EQ(g.data[7].size(), 4); EXPECT_EQ(g.data[7][0], std::make_pair(2ull, 70.0)); EXPECT_EQ(g.data[7][1], std::make_pair(6ull, 40.0)); EXPECT_EQ(g.data[7][2], std::make_pair(8ull, 30.0)); EXPECT_EQ(g.data[7][3], std::make_pair(12ull, 60.0));
	EXPECT_EQ(g.data[8].size(), 4); EXPECT_EQ(g.data[8][0], std::make_pair(3ull, 50.0)); EXPECT_EQ(g.data[8][1], std::make_pair(7ull, 30.0)); EXPECT_EQ(g.data[8][2], std::make_pair(12ull, 5.0)); EXPECT_EQ(g.data[8][3], std::make_pair(13ull, 70.0));
	EXPECT_EQ(g.data[9].size(), 2); EXPECT_EQ(g.data[9][0], std::make_pair(4ull, 10.0)); EXPECT_EQ(g.data[9][1], std::make_pair(14ull, 25.0));
	EXPECT_EQ(g.data[10].size(), 3); EXPECT_EQ(g.data[10][0], std::make_pair(5ull, 30.0)); EXPECT_EQ(g.data[10][1], std::make_pair(6ull, 10.0)); EXPECT_EQ(g.data[10][2], std::make_pair(11ull, 10.0));
	EXPECT_EQ(g.data[11].size(), 2); EXPECT_EQ(g.data[11][0], std::make_pair(10ull, 10.0)); EXPECT_EQ(g.data[11][1], std::make_pair(12ull, 35.0));
	EXPECT_EQ(g.data[12].size(), 4); EXPECT_EQ(g.data[12][0], std::make_pair(7ull, 60.0)); EXPECT_EQ(g.data[12][1], std::make_pair(8ull, 5.0)); EXPECT_EQ(g.data[12][2], std::make_pair(11ull, 35.0)); EXPECT_EQ(g.data[12][3], std::make_pair(13ull, 70.0));
	EXPECT_EQ(g.data[13].size(), 2); EXPECT_EQ(g.data[13][0], std::make_pair(8ull, 70.0)); EXPECT_EQ(g.data[13][1], std::make_pair(12ull, 70.0));
	EXPECT_EQ(g.data[14].size(), 1); EXPECT_EQ(g.data[14][0], std::make_pair(9ull, 25.0));
}
